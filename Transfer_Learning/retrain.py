  ...
  if FLAGS.print_misclassified_test_images:
    ...
    for i, test_filename in enumerate(test_filenames):
      if predictions[i] != test_ground_truth[i]:
        ...
        test_error_images.append([test_filename,list(image_lists.keys())[predictions[i]]])
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/content/example_code/gesture_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/content/example_code/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/content/example_code/gesture_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/content/example_code/retrain_logs',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/content/example_code/bottleneck',
  ...
  parser.add_argument(
      '--checkpoint_path',
      type=str,
      default='/content/example_code/_retrain_checkpoint',
